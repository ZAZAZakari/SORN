'''
======================================================================================
DESCRIPTION: IMPLEMENTION OF SOLVING THE ALL ONES PROBLEM WITH LEARNING + EVOLUTION
DATE: 23 JUNE 2014
======================================================================================
'''
...
N = 20					# [INTEGER] PROBLEM DIMENSIONALITY
...
NN_I = 24				# [INTEGER] NUMBER OF INHIBITORY NEURONS IN THE MODEL = 0.2*NN_E 
...
strength = 0.8			# [FLOATING NUMBER] STRENGTH OF EXTERNAL INPUT NEURONS
...
stateIteration = 50		# [INTEGER] NUMBER OF TIME STEPS IN EACH ITERATION
iteration = 1800		# [INTEGER] NUMBER OF ITERATIONS
...
tempx = np.zeros(shape=(2, NN_E))				# [2D ARRAY] THE SAVING PARAMETERS FOR x
tempy = np.zeros(shape=(2, NN_I))				# [2D ARRAY] THE SAVING PARAMETERS FOR y
...
savedTE = np.zeros(shape=(3, NN_E))				# [2D ARRAY] THE SAVING PARAMETERS FOR te
savedTI = np.zeros(shape=(3, NN_I))				# [2D ARRAY] THE SAVING PARAMETERS FOR ti
'''
======================================================================================
...
np.savetxt('fitness_learning_evolution.txt', scoreFig)
