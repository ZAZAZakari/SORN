...
3. (A) SOLVING THE ROYAL ROAD FITNESS WITH GA
		--- (1) RUN "python GA_RoyalRoadFitness_evolution.py"
		--- (2) RESULT IS OUTPUT AS TEXT FILE "fitness_evolution.txt"
   (B) SOLVING THE ROYAL ROAD FITNESS WITH SORNGA
		--- (1) RUN "python GA_RoyalRoadFitness_learning+evolution.py"
